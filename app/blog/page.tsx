...
export default function BlogIndex() {
  ...
  return (
    <>
      <section className="bg-forest-900 text-cream-50 py-20">
          ...
          {posts.length === 0 ? (
            ...
            <div className="space-y-10">
              {posts.map((p) => (
                ...
                >
                  <div className="md:col-span-4 aspect-[16/10] rounded-xl overflow-hidden bg-forest-100">
                    {p.cover ? (
                  ...
                  <div className="md:col-span-8">
                    ...
                    <h2 className="font-serif text-2xl md:text-3xl text-forest-900 mb-3 leading-snug group-hover:text-forest-700 transition-colors">
                      {p.title}
                    </h2>
